...
A TLS certificate validation flaw was found in the monitoring feature of {ls}.
When specifying a trusted server CA certificate {ls} would not properly
...
{ls} monitoring data. All versions of Logstash after 6.4.0 and before
versions 6.8.15 and 7.12.0 are affected by this flaw.
You must upgrade to 6.8.15 or 7.12.0 to obtain the fix.
https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2021-22138[CVE-2021-22138]
